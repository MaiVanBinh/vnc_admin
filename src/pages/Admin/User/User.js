...
const User = (props) => {
  const { auth, listUsers, setlistUsers, setLoader } = props;
  ...
  }, [setlistUsers, setLoader, auth.token, filterList]);

  useEffect(() => {
    getListUsers();
  }, [filterList, getListUsers]);
  ...
  return (
    <div className="container-fluid pt-3 pb-5">
      ...
      <div className="pagination mt-4 d-flex justify-content-center">
        {listUsers ? (
          <Pagination pagination={listUsers.pages} callFetchList={changePage} />
        ) : null}
      </div>
          ...
          <Form>
            ...
            <Form.Group controlId="formBasicConfirmPassword">
              ...
              <Form.Control
                ...
                onChange={(v) =>
                  setInfo({ ...info, rePassword: v.target.value })
                }
